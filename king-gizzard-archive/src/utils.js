...
// Utility functions for King Gizzard Archive
...
// King Gizzard specific constants  
export const KINGGIZZARD_MBID = 'f58384a4-2ad2-4f24-89c5-c7b74ae1cce7';
export const KINGGIZZARD_ARTIST = { name: 'King Gizzard & The Lizard Wizard', mbid: KINGGIZZARD_MBID };
...
export const fetchAllUMOSetlists = async (apiBaseUrl) => {
  try {
    console.log(`🎸 Fetching ALL King Gizzard performances from cache...`);
    ...
    console.error(`❌ Error fetching all cached King Gizzard setlists:`, error);
    throw error;
  }
};
...
export const fetchUMOSetlists = async (page = 1, apiBaseUrl) => {
  try {
    console.log(`🎸 Fetching King Gizzard performances from cache (page ${page})...`);
    ...
    console.error(`❌ Error fetching cached King Gizzard setlists:`, error);
    throw error;
  }
};
