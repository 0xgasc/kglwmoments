...
// Web3 functionality removed for King Gizzard version
      ...
      <div className="block sm:hidden">
        ...
        {showHowToGuide && (
          <div className="mb-4 umo-card p-3">
            <h3 className="umo-heading umo-heading--sm mb-2">How to Use King Gizzard Archive</h3>
            <p className="umo-text-secondary text-xs mb-3">
              Explore King Gizzard's performance history and upload your concert moments.
            </p>
          ...
          <div className="flex-1 min-w-0">
            ...
            {showHowToGuide && (
              <div className="mt-3 umo-card p-4">
                <h3 className="umo-heading umo-heading--md mb-3">How to Use King Gizzard Archive</h3>
                <p className="umo-text-secondary text-sm mb-4">
                  Explore King Gizzard's complete performance history and upload your own concert moments.
                </p>
...
// King Gizzard Archive - No Web3 providers needed
